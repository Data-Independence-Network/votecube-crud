...
var (
	countryColumns               = []string{"country_id", "country_code", "country_code3", "country_name", "country_full_name", "created_date", "expired_date", "continent_id"}
	countryColumnsWithoutDefault = []string{"country_id", "country_code", "country_code3", "country_name", "country_full_name", "created_date", "expired_date", "continent_id"}
...
func (o *Country) EthnicGroupCountries(mods ...qm.QueryMod) ethnicGroupCountryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"ethnic_group_country\".\"country_id\"=?", o.CountryID),
	)
...
func (o *Country) PollsCountries(mods ...qm.QueryMod) pollsCountryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"polls_country\".\"country_id\"=?", o.CountryID),
	)
...
func (o *Country) States(mods ...qm.QueryMod) stateQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"state\".\"country_id\"=?", o.CountryID),
	)
...
func (countryL) LoadContinent(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCountry interface{}, mods queries.Applicator) error {
	var slice []*Country
	var object *Country
...
func (countryL) LoadEthnicGroupCountries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCountry interface{}, mods queries.Applicator) error {
	var slice []*Country
	var object *Country
	...
	query := NewQuery(qm.From(`ethnic_group_country`), qm.WhereIn(`country_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (countryL) LoadPollsCountries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCountry interface{}, mods queries.Applicator) error {
	var slice []*Country
	var object *Country
	...
	query := NewQuery(qm.From(`polls_country`), qm.WhereIn(`country_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (countryL) LoadStates(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCountry interface{}, mods queries.Applicator) error {
	var slice []*Country
	var object *Country
	...
	query := NewQuery(qm.From(`state`), qm.WhereIn(`country_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Country) SetContinent(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Continent) error {
	...
	values := []interface{}{related.ContinentID2, o.CountryID}
...
func (o *Country) AddEthnicGroupCountries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*EthnicGroupCountry) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.CountryID, rel.EthnicGroupCountryID}
...
func (o *Country) AddPollsCountries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PollsCountry) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.CountryID, rel.PollCountryID}
...
func (o *Country) AddStates(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*State) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.CountryID, rel.StateID}
...
func (o *Country) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryCockroachDB(dialect, "\"country\"", updateOnConflict, ret, update, conflict, insert)
