...
func testColorToManyDimensions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := ColorSlice{&a}
	if err = a.L.LoadDimensions(ctx, tx, false, (*[]*Color)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testColorToManyPollsDimensionsDirections(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := ColorSlice{&a}
	if err = a.L.LoadPollsDimensionsDirections(ctx, tx, false, (*[]*Color)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testColorToManyAddOpDimensions(t *testing.T) {
	var err error
...
func testColorToManyAddOpPollsDimensionsDirections(t *testing.T) {
	var err error
